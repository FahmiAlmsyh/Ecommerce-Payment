...
@section('main')
    ...
    @include('frontend.components.browse')
            ...
            <div class="flex -mx-4 flex-row relative">
                ...
                @foreach ($products as $p)
                    <div class="px-4 relative card group">
                        ...
                        <h5 class="text-lg font-semibold mt-4">{{ $p->nama }}</h5>
                        <span class="">{{ number_format($p->harga) }}</span>
                        <a href="{{ route('detail', $p->id) }}" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
