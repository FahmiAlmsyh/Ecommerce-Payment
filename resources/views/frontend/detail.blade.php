    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
                ...
                <div class="slider">
                    <div class="preview">
                        <div class="item rounded-lg h-full overflow-hidden">
                            <img src="{{ asset('storage/' . $products->foto) }}" alt="front"
            ...
            <div class="flex-1 px-4 md:p-6">
                <h2 class="text-5xl font-semibold">{{ $products->nama }}</h2>
                <p class="text-xl">IDR {{ number_format($products->harga) }}</p>
                ...
                <form action="{{ route('cart-add', $products->id) }}" method="POST">
                    ...
                    <div class="mb-3 mt-5">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control text-center" name="qty" id="qty"
                                value="1" min="1" max="{{ $products->qty }}" aria-describedby="helpId" />
                            <button class="btn btn-outline-secondary" type="button" id="incrementBtn">+</button>
                        </div>
                        @if ($products->qty <= 0)
                            <div class="text-danger mt-2">This product is out of stock.</div>
                        @endif
                    </div>
                    ...
                    <button type="submit"
                        ...
                        @if ($products->qty <= 0) disabled @endif>
