            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('products_dashboard.update', $product->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $product->foto) }}" style="width: 20%" alt="">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3">{{ $product->deskripsi }}</textarea>
                                </div>
